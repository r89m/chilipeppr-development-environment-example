...
cpdefine("inline:com-chilipeppr-widget-eagle", ["chilipeppr_ready", "Clipper"], function () {
    return {
        ...
        onDraw3dReady: function () {
            ...
            this.draw3dSignalWires(this.eagle.eagleLayersByName['Bottom']);
            this.draw3dSignalPolygons(this.eagle.eagleLayersByName['Bottom']);
            this.draw3dElements(this.eagle.eagleLayersByName['Bottom']);
        ...
        clearanceHeight: 2.0, // move z to clearance
        // 1 oz = 0.035mm, 2 oz = 0.07mm, 3 oz = 0.105mm
        depthOfSignalMilling: -0.07, // cutting how deep?
        ...
        exportGcode: function() {
            ...
            var g = "(Gcode generated by ChiliPeppr Eagle PCB Widget " + (new Date()).toLocaleString() + ")\n";
            g += "G21 (mm mode)\n";
            g += "G90 (abs mode)\n";
            g += "M3 (spindle on)\n";
            g += "TO M6 (set tool)\n"
        ...
        draw3dVias: function (layersName) {
            ...
            for (var signalKey in this.eagle.signalItems) {
                ...
                layerVias.forEach(function (via) {
                    ...
                    var line = new THREE.Line(viaGeo, lineMat);
                    line.position.set(via.x, via.y, 0);
        ...
        draw3dElements: function (layer) {
            ...
            for (var elemKey in this.eagle.elements) {
                ...
                pkg.pads.forEach(function (pad) {
                    ...
                    var drillLines = new THREE.Line(circleGeo, drillMat);
                    //drillLines.position.set(elem.x + pad.x, elem.y + pad.y, 0);
                    drillLines.userData["type"] = "drill";

                    group.add(drillLines);
                    //that.sceneAdd(drillLines);
